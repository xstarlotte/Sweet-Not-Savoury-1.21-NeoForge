...
public class BedFeetBlockDestroyedByExplosionProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        if ((world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == SNSBlock.BED_HEAD.get() && (new Object() {
        ...
        } else if ((world.getBlockState(BlockPos.containing(x - 1, y, z))).getBlock() == SNSBlock.BED_HEAD.get() && (new Object() {
            public Direction getDirection(BlockPos pos) {
                BlockState _bs = world.getBlockState(pos);
                Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
                if (property != null && _bs.getValue(property) instanceof Direction _dir)
        ...
        } else if ((world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == SNSBlock.BED_HEAD.get() && (new Object() {
            public Direction getDirection(BlockPos pos) {
                BlockState _bs = world.getBlockState(pos);
                Property<?> property = _bs.getBlock().getStateDefinition().getProperty("facing");
                if (property != null && _bs.getValue(property) instanceof Direction _dir)
